...
function Indice({
  ...
  return (
    <div
      onClick={handleClick}
      className="bg-gray-600 hover:bg-gray-400 border border-gray-200 rounded-lg 
      shadow-sm flex justify-between gap-2.5 items-center px-4 py-4 mx-3 my-2 transition-all duration-200 hover:shadow-md w-85 min-w-0"
    >
